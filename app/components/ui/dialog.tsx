    ...
    <FullWindowOverlay>
      <DialogPrimitive.Overlay
        ...
        <NativeOnlyAnimatedView
          ...
          as="Pressable">
          {/* Local edit to the RNR source: this wrapper shipped without a width.
              The overlay centres its children, so the wrapper shrank to fit the
              content, and DialogContent's `w-full` then resolved against a
              content-sized parent — the dialog hugged its text and grew wider
              with every character typed. An explicit 100% gives the percentage
              chain something definite to resolve against. */}
          <NativeOnlyAnimatedView
            style={{ width: '100%' }}
